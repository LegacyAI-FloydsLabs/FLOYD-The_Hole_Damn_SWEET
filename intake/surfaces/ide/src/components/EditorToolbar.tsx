  ...
  return (
    <div className="editor-toolbar">
      ...
      <div className="editor-actions">
        <button className="icon-button compact" onClick={() => dispatchEditorCommand('inlineEdit')} title="CURSEM Inline Edit (⌘K)" aria-label="CURSEM Inline Edit"><Icon name="spark" size={15} /></button>
        <button className="icon-button compact" onClick={() => dispatchEditorCommand('undo')} title="Undo" aria-label="Undo"><Icon name="undo" size={15} /></button>
        <button className="icon-button compact" onClick={() => dispatchEditorCommand('redo')} title="Redo" aria-label="Redo"><Icon name="redo" size={15} /></button>
        ...
        <button className="icon-button compact" onClick={() => dispatchEditorCommand('export')} title="Export active file" aria-label="Export active file"><Icon name="download" size={15} /></button>
      </div>
    </div>
  );
}
