...
const ADMITTED_SURFACES = Object.freeze([
  {
    ...
    sourceRoot: join(ROOT_DIR, "intake", "surfaces", "desktop"),
  ...
  },
  {
    ...
    sourceRoot: join(ROOT_DIR, "intake", "surfaces", "ide"),
  ...
  },
  {
    ...
    sourceRoot: join(ROOT_DIR, "intake", "surfaces", "pty"),
  ...
  },
  {
    ...
    sourceRoot: join(ROOT_DIR, "intake", "surfaces", "launcher"),
