(function() {
  ...
  const HOST_ID = 'anvil-agent-indicator-host';
  ...
  function showIndicator() {
    ...
    host.id = HOST_ID;
    host.setAttribute('data-anvil-indicator', 'true');
    ...
    style.textContent = `
      .anvil-overlay {
        ...
        animation: anvil-pulse 1.5s ease-in-out infinite;
      }
    ...
    overlay.className = 'anvil-overlay';
    overlay.setAttribute('data-anvil-indicator', 'true');

    // Create stop button
    const stopBtn = document.createElement('button');
    stopBtn.className = 'anvil-stop-btn';
    stopBtn.textContent = 'Stop';
    stopBtn.setAttribute('data-anvil-indicator', 'true');
