...
(function () {
  ...
  async function writeObservation(args) {
    ...
    if (args.type === 'verification_report') {
      ...
      if (window.__anvilVerification) {
        md = window.__anvilVerification.formatVerificationReport(args);
      } else {
  ...
  async function executeToolCall(name, args) {
    switch (name) {
      ...
      case 'audit_ui':           return window.__anvilUiGate ? window.__anvilUiGate.audit() : { error: 'UI Gate not loaded' };
      default:
