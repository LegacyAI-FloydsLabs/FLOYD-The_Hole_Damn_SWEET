 ...
 *
 * `modelsPath` + `modelsShape` describe each provider's LIVE model-list
 * endpoint (verified reachable through the vault proxy 2026-07-31). The
 * static `models` arrays are offline fallbacks for the live broker, never a
 * selector's primary source.
 */
export const VAULT_PROVIDER_CATALOG = Object.freeze({
  openai: Object.freeze({
    ...
    models: ["gpt-5.6-terra", "gpt-5.6-sol", "gpt-5.6-luna", "gpt-5.2-codex"], capabilities: ["responses", "chat", "streaming", "tools", "images"],
  }),
  anthropic: Object.freeze({
    ...
    modelsPath: "/v1/models", modelsShape: "anthropic",
  ...
  google: Object.freeze({
    ...
    auth: "google", modelsPath: "/v1beta/models", modelsShape: "google",
    models: ["gemini-2.5-pro"], capabilities: ["chat", "streaming", "tools", "attachments", "images"],
  }),
  deepseek: Object.freeze({
    ...
    modelsPath: "/models", modelsShape: "openai",
  ...
  mistral: Object.freeze({
    ...
    modelsPath: "/v1/models", modelsShape: "openai",
  ...
  zai: Object.freeze({
    ...
    // The coding-plan endpoint's list reflects what the plan can actually use.
    modelsPath: "/api/coding/paas/v4/models", modelsShape: "openai",
  ...
  groq: Object.freeze({
    ...
    modelsPath: "/openai/v1/models", modelsShape: "openai",
